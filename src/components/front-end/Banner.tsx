    ...
    return (
        <div className="container mt-16 lg:mt-24">
            <div className="grid grid-cols-1 lg:grid-cols-[66%,34%] gap-6 lg:gap-8 pr-4 lg:pr-0">
                ...
                <div 
                    className="h-[300px] md:h-[400px] lg:h-[500px] bg-[url('/path/to/your/combined-banner.jpg')] bg-cover bg-center rounded-xl p-6 md:p-10 lg:p-12 flex flex-col justify-between shadow-md hover:shadow-lg transition-shadow"
                >
                    <div>
